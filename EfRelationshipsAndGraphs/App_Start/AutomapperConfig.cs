    ...
    public static class AutomapperConfig
    {
        public static void Configure()
        {
            Mapper.CreateMap<Charter, MoeViewModel>()
                ...
                //.ForMember(d => d.CostlyExpenditures, op => op.Ignore())
                //.ForMember(d => d.CostlyExpendituresTotal, op => op.Ignore())
            ;
            ...
            Mapper.CreateMap<Exemption, MoeViewModel>()
                .ForMember(d => d.ExemptionName, op => op.MapFrom(s => s.Name))
                .ForMember(d => d.CostlyExpendituresTotal, op => op.MapFrom(s => s.CostlyExpendituresTotal))
                .ForMember(d => d.CostlyExpenditures, op => op.MapFrom(s => s.CostlyExpenditures))
                //.ForMember(d => d.MoeId, op => op.Ignore())
                //.ForMember(d => d.MoeName, op => op.Ignore())
                //.ForMember(d => d.ActualOrBudget, op => op.Ignore())
                //.ForMember(d => d.RelatedMoeId, op => op.Ignore())
